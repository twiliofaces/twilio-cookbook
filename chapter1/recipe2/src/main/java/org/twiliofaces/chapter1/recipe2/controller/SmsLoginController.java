...
import org.twiliofaces.chapter1.recipe2controller.util.Utils;

@Named
@SessionScoped
public class SmsLoginController implements Serializable {

	private static final long serialVersionUID = 1L;

	Logger logger = Logger.getLogger(SmsLoginController.class.getName());
